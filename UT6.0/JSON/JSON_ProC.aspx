<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JSON_ProC.aspx.cs" Inherits="JSON_JSON_ProC" %>
        ...
        <br />
         <asp:Button ID="Bnt_XmlDataSet" runat="server" Text="XmlDataSet" OnClick="Bnt_XmlDataSet_Click" />
          <asp:Label ID="lbl_Re13" runat="server" Text="Label"></asp:Label>
            <br />
            <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="jTEST" />
        <br />
