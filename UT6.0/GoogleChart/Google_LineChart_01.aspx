<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Google_LineChart_01.aspx.cs" Inherits="GoogleChart_Google_LineChart_01" %>
...
<body>
    <form id="form1" runat="server">
            ...
            <h4>현황 그래프</h4>
            <div id="Line_Controls_Chart"> </div>
              <!-- 라인 차트 생성할 영역 -->
            ...
            function drawDashboard() {
                ...
                var chart = new google.visualization.ChartWrapper({
                    ...
                    options: {
                        ...
                        pointSize: 5,
                        showColorCode: true, trigger: 'both'
                    }
